...
const pillars = [
  {
    title: "Vite como padrao",
    description:
      "Scripts principais apontando diretamente para Vite, sem camada intermediaria no caminho.",
    icon: ZapIcon,
  },
  {
...
const readyItems = [
  "Scripts principais usando Vite puro",
  "Entrada HTML e React client-side",
              ...
              <div className="flex flex-col gap-5">
                ...
                <div className="flex flex-col gap-4">
                  <h1 className="max-w-3xl text-5xl font-semibold tracking-tight text-balance sm:text-6xl">
                    Vite, Bun, Vitest e shadcn numa base pronta para produto.
                  </h1>
                  <p className="max-w-2xl text-lg leading-8 text-muted-foreground sm:text-xl">
                    Esse starter ja nasce com React client-side, Vite,
                    componentes shadcn/ui, Tailwind v4 e uma estrutura enxuta
                    para crescer sem recomecar do zero.
                  </p>
                </div>
              </div>
